#' @title Calculate cohesive blocks from adjacency matrices
#' @description This function uses the \pkg{igraph} package to calculate
#' cohesive blocks from a adjacency matrix.
...
#' ppcor_statistics <- network_statistics_cohesive_blocks(ppcor_parsed)
#' # visualize
#' ppcor_statistics

network_statistics_cohesive_blocks <-
  function (adj_mat,
            weighted = TRUE,
            mode = "undirected",
            diag = TRUE,
